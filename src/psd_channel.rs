...
impl PsdChannelCompression {
    ...
    pub fn new(compression: u16) -> Result<PsdChannelCompression, ChannelError> {
        match compression {
...
impl PsdChannelKind {
    ...
    pub fn new(channel_id: i16) -> Result<PsdChannelKind, ChannelError> {
        match channel_id {
            ...
            _ => Err(ChannelError::InvalidId(channel_id)),
        }
    }
